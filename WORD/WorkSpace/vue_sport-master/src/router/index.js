...
import Visualization from '../components/sensors/Visualization.vue'
...
const routes = [
  ...
  },
  {
    ...
    redirect: '/welcome',
    children: [
      { path:'/welcome', component: Welcome},{ path:'/user', component: User},{ path:'/Device', component: Device},{ path:'/Visualization', component: Visualization}
    ],
  },
]
